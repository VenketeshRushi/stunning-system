...
import templatesImg from "@/assets/images/resource-allocation/templates.webp";
import graveyardImg from "@/assets/images/resource-allocation/graveyard.webp";
import discussionsImg from "@/assets/images/resource-allocation/discussions.webp";
import notificationsImg from "@/assets/images/resource-allocation/notifications.webp";

import jiraLogo from "@/assets/images/logos/jira.svg";
import excelLogo from "@/assets/images/logos/excel.svg";
import notionLogo from "@/assets/images/logos/notion.svg";
import wordLogo from "@/assets/images/logos/word.svg";
...
const topItems: ItemType[] = [
  ...
  },
  {
    ...
    images: [
      { src: jiraLogo, alt: "Jira logo", width: 48, height: 48 },
      { src: excelLogo, alt: "Excel logo", width: 48, height: 48 },
      { src: notionLogo, alt: "Notion logo", width: 48, height: 48 },
      { src: wordLogo, alt: "Word logo", width: 48, height: 48 },
      { src: mondayLogo, alt: "Monday logo", width: 48, height: 48 },
      { src: driveLogo, alt: "Google Drive logo", width: 48, height: 48 },
      { src: jiraLogo, alt: "Jira logo", width: 48, height: 48 },
      { src: asanaLogo, alt: "Asana logo", width: 48, height: 48 },
    ],
    className:
    ...
    >
      <div>
        <h2 className='container text-center text-3xl tracking-tight text-balance sm:text-4xl md:text-5xl lg:text-6xl'>
          Genie your resource allocation and execution
        </h2>
